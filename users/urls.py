...
urlpatterns = [
    ...
    url(r"^preferences/$", views.UserPreferencesUpdate.as_view(), name="custom-user-preferences-update"),
    url(r"^preferences/menu-expansion/$", views.menu_expansion_update_view, name="custom-user-menu-expansion-update"),
