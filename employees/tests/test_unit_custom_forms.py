...
class ProjectJoinFormTests(TestCase):
    def test_project_join_form_should_create_choice_field_with_project_name_and_id_based_author_passed_in_initial(self):
        queryset_length = 10
        ...
        custom_kwargs = {"initial": {"author": custom_user}}
        queryset = Project.objects.all()
        form = ProjectJoinForm(**custom_kwargs)
