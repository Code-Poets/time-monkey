...
class ReportExtractor:
    ...
    def _set_row_height(self, description: str) -> None:
        # If the description has \ n or text exceeds 100 characters, it is automatically moved to the new line.
    ...
    def _set_printing_settings_for_current_sheet(self) -> None:
        self._workbook.get_active_sheet().set_printer_settings(paper_size=9, orientation="landscape")
        self._workbook.get_active_sheet().sheet_properties.pageSetUpPr.fitToPage = True
        self._workbook.get_active_sheet().page_setup.fitToHeight = False
